...
#Новый тэг:
Чтобы добавить изображение надо обернуть путь до него в ***

Пример:

***путь/до/изображения.jpg\***

превратится в \<img src="путь/до/изображения.jpg">

Тэг с изображением можно вкладывать внутрь остальных
